...
BirdDude.prototype.update = function() {
	...
	if (this.outsideScreen()) {
		...
		console.log("BirdDude's angle was changed to "+this.angle);
		
		//put bird dude back inside the screen
		...
		console.log("BirdDude's X was changed by "+this.speed*Math.cos(this.angle));
        this.y += this.speed*Math.sin(this.angle);
		console.log("BirdDude's Y was changed by "+this.speed*Math.sin(this.angle));
